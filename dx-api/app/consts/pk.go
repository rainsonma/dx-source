...
var PkDifficulties = map[string]PkDifficultyParams{
	PkDifficultyEasy:   {AccuracyMin: 0.50, AccuracyMax: 0.70, MinDelayMs: 5000, MaxDelayMs: 9000, ComboBreakPct: 0.50},
	PkDifficultyNormal: {AccuracyMin: 0.70, AccuracyMax: 0.85, MinDelayMs: 3500, MaxDelayMs: 6000, ComboBreakPct: 0.30},
	PkDifficultyHard:   {AccuracyMin: 0.85, AccuracyMax: 0.95, MinDelayMs: 2000, MaxDelayMs: 4000, ComboBreakPct: 0.10},
}
