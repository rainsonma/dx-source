...
import { CreateCourseForm } from "@/features/web/ai-custom-vocab/components/create-course-form"
import { GameCardItem } from "@/features/web/ai-custom-vocab/components/game-card-item"
import { useInfiniteGames } from "@/features/web/ai-custom-vocab/hooks/use-infinite-games"
...
export function AiCustomVocabGrid() {
    ...
    <>
      ...
      <div className="flex flex-col gap-4 rounded-2xl bg-gradient-to-tr from-teal-700 via-teal-600 to-purple-400 p-5 pb-6 lg:p-7 lg:pb-8">
        ...
        <p className="text-sm leading-relaxed text-white/80">
          自定义词汇内容，AI 自动拆解生成练习单元，通过词汇配对、消消乐、对轰等趣味游戏模式轻松掌握单词
        </p>
      </div>
      ...
      <UpgradeDialog
        ...
        title="会员专属功能"
        message="升级会员即可使用 AI 词汇工坊，创建专属词汇学习课程"
      />
    </>
  )
}
