...
import { AddLevelDialog } from "@/features/web/ai-custom-vocab/components/add-level-dialog";
import { useDeleteGameLevel } from "@/features/web/ai-custom-vocab/hooks/use-game-actions";
          ...
          {levels.map((level, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <Link
                  href={`/hall/ai-custom-vocab/${gameId}/${level.id}`}
