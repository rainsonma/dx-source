  ...
  return (
    <>
      <DocSection id="what" title="学习小组的定位">
        <p>
          学习小组是斗学里的&ldquo;多人空间&rdquo;：一群人组合在一起，可以一起开局游戏、看到彼此的进度、在小组内讨论。相比 PK 的临时对战，小组是更稳定、更长期的学习伙伴关系——不是来互相督促的，是来一起玩的。
        </p>
        <p>
          小组的用途很多：朋友之间的固定约战、同学间的组队刷题、家庭成员一起学英语。斗学不限制小组的主题，你可以按任何方式组织。
        </p>
      </DocSection>
