...
export default function LearningModesOverview() {
  return (
    <>
      <DocSection id="three-modes" title="三种模式，一套知识">
        <p>
          斗学把同一套游戏内容设计成了三种玩法：单人闯关、PK 对战、小组共学。它们不是彼此替代的不同&ldquo;游戏&rdquo;，而是同一个游戏的三种节奏——你可以在心情不同的时候自由切换。
        </p>
        <p>
      ...
      <DocSection id="shared-basics" title="三种模式的共同基础">
        <p>
