    ...
    <div className="flex min-h-full flex-col gap-5 px-4 pt-5 pb-12 lg:gap-6 lg:px-8 lg:pt-7 lg:pb-16">
      ...
      <div className="flex flex-1 flex-col overflow-hidden rounded-[14px] border border-border bg-card">
        ...
        <div className="shrink-0 p-4 pb-0 lg:p-5 lg:pb-0">
          <div className="flex flex-col items-stretch gap-3 pb-2 pt-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 rounded-lg bg-teal-600 px-3 py-2 text-sm font-semibold text-white hover:bg-teal-700"
            >
